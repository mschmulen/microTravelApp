...
// in simulator we redefine to format for travelAppMobile Developer console
...
{\
	NSString * exceptionName = [@"org.travelappmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.travelappmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UItravelAppMobileNativeItemNone = -1, 
	UItravelAppMobileNativeItemSpinner = -2,
	UItravelAppMobileNativeItemProgressBar = -3,
	
	UItravelAppMobileNativeItemSlider = -4,
	UItravelAppMobileNativeItemSwitch = -5,
	UItravelAppMobileNativeItemMultiButton = -6,
	UItravelAppMobileNativeItemSegmented = -7,
	
	UItravelAppMobileNativeItemTextView = -8,
	UItravelAppMobileNativeItemTextField = -9,
	UItravelAppMobileNativeItemSearchBar = -10,
	
	UItravelAppMobileNativeItemPicker = -11,
	UItravelAppMobileNativeItemDatePicker = -12,
	
	UItravelAppMobileNativeItemInfoLight = -13,
	UItravelAppMobileNativeItemInfoDark = -14,
	
	UItravelAppMobileNativeItemDisclosure = -15,
	
	UItravelAppMobileNativeItemContactAdd = -16
};
